...
class EmpleadoAdapter(private val lista: List<Empleado>,private val onItemClick:(Empleado)-> Unit) :
    ...
    class EmpleadoViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(emp: Empleado, onItemClick: (Empleado) -> Unit) {
            tvNombre.text = emp.nombre
            tvPuesto.text = emp.puesto
            tvTelefono.text = emp.telefono
            itemView.setOnClickListener {
                onItemClick(emp)  // avisamos a la Activity
            }
        }
    }
